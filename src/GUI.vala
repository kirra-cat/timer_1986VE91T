...
namespace GUI
{
  ...
  public Gtk.SpinButton divider_spin_box;
  ...
  {         
    ...
    public LayoutWidgets.create_gui()
    {
      ...
      divider_spin_box = new Gtk.SpinButton.with_range (1, 65535, 1);
      divider_spin_box.set_alignment((float) 0.5);
      grid.attach(divider_spin_box, 1, 2, 2, 1);
      divider_spin_box.adjustment.value_changed.connect(Callback.on_changed_callback);
      ...
      timer_psg_entry.set_icon_from_icon_name(Gtk.EntryIconPosition.SECONDARY, Gtk.Stock.COPY);
      ...
      timer_arr_entry.set_icon_from_icon_name(Gtk.EntryIconPosition.SECONDARY, Gtk.Stock.COPY);
      ...
      Gtk.Image update_data_image = new Gtk.Image.from_icon_name(Gtk.Stock.REFRESH, Gtk.IconSize.BUTTON);
      update_data_button.set_image(update_data_image);
      ...
      button_grid.attach(update_data_button, 0, 0, 1, 1);

      clear_button = new Gtk.Button();
      Gtk.Image clear_image = new Gtk.Image.from_icon_name(Gtk.Stock.CLEAR, Gtk.IconSize.BUTTON);
      clear_button.set_image(clear_image);
      clear_button.set_image_position(Gtk.PositionType.LEFT);
      clear_button.halign = Gtk.Align.END;
      button_grid.attach(clear_button, 1, 0, 1, 1);

      clear_button.clicked.connect(() =>
      {
        HCLK_entry.set_text("");
        divider_spin_box.adjustment.value = 1;
        timer_clk_entry.set_text("");
        result_entry.set_text("");
        timer_psg_entry.set_text("");
        timer_arr_entry.set_text("");
      });
      
      grid.attach(button_grid, 2, 8, 1, 1);
